...
class PitchForm(FlaskForm):
    ...
    category = SelectField('Select Pitch Category', choices=[('Product Pitch', 'Product Pitch'),('Interview Pitch', 'Interview Pitch'),('Idea Pitch','Idea Pitch')], validators = [Required()])
